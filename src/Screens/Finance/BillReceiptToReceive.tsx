...
export interface BillReceiptPaymentProps {
  billReceipts: BillReceipt[]
  onPay?: () => void
}

interface BillReceiptPaymentScreenProps extends ScreenProps, BillReceiptPaymentProps {}
const BillReceiptPayment = (props: BillReceiptPaymentScreenProps) => {
...
export default BillReceiptPayment
