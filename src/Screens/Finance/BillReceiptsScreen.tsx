...
export const BillReceiptsScreen: React.FC<ScreenProps> = ({ screen }): JSX.Element => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        sortable: true,
        formatText: (r) => new Date(r!.opening_date as string).toLocaleString(
          undefined,
      ...
      },
      {
        ...
        sortable: true,
        formatText: (r) => new Date(r!.due_date as string).toLocaleString(
          undefined,
          DateFormats.DATE_SHORT_TIME
        ),
        filters: [
  ...
  const registrationButtonBarProps: RegistrationButtonBarProps = {
    ...
    handleSaveButtonOnClick: screenStatus === ScreenStatus.NEW
      ...
      },
      {
        ...
        columns: [
          ...
          },
          {
            ...
            formatText: (c) => new Date(c.transaction_created_at).toLocaleDateString(
              undefined,
      ...
      <Render renderIf={screenStatus !== ScreenStatus.SEE_REGISTERS}>
        ...
        <Row>
          ...
          <InputDate
            ...
            timePrecision='minute'
            closeOnSelection={false}
            formatDate={(d) => d.toLocaleString(undefined, DateFormats.DATE_SHORT_TIME)}
            style={{ flex: 1 }}
          ...
          <Render renderIf={!payload.id}>
            <InputNumber
              ...
              min={0}
              inputStyle={{ width: 'calc(100% - 34px)' }}
              onValueChange={(value) => changePayloadAttribute('installments', value)}
              style={{ flex: 1 }} />
          </Render>
        </Row>
      </Render>
